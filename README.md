...
<img src="assets/workflow-modern.png" alt="Skaz workflow as a fairy-tale illustration: voice flows from a speaking horn, picks up framed moments along the way, ends in an open book of words and pictures" width="100%">
