...
<img src="assets/workflow-blueprint-flow-v1.png" alt="Skaz workflow as a geometric infographic: voice on the left, three screenshot moments along a timeline in the middle, merged Markdown document on the right" width="100%">
